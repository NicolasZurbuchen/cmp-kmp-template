...
import io.nicolaszurbuchen.appname.feature.pokemonexplorer.data.datasource.remote.dto.PokemonSpritesDto
...
class PokemonExplorerRepositoryImplTest {
    ...
    @Test
    fun fetchRandomPokemon_requestsSpeciesIdWithinValidPokedexRange() = runTest {
    ...
    @Test
    fun fetchRandomPokemon_insertsFetchedPokemonIntoLocalDataSource() = runTest {
    ...
    @Test
    fun fetchRandomPokemon_missingSprite_insertsEmptySpriteUrl() = runTest {
    ...
    @Test
    fun fetchRandomPokemon_returnsDomainPokemonWithHistoryIdFromLocalInsert() = runTest {
    ...
    @Test
    fun observeHistory_mapsLocalRowsToDomainPokemonList() = runTest {
        val cached = CachedPokemon(id = 1L, pokemon_id = 25L, name = "pikachu", sprite_url = "url", height = 4L, weight = 60L, fetched_at = 100L)
    ...
    @Test
    fun clearHistory_delegatesToLocalDataSource() = runTest {
    ...
    @Test
    fun getById_existingId_returnsMappedDomainPokemon() = runTest {
        val cached = CachedPokemon(id = 3L, pokemon_id = 25L, name = "pikachu", sprite_url = "url", height = 4L, weight = 60L, fetched_at = 100L)
    ...
    @Test
    fun getById_missingId_returnsNull() = runTest {
        val local = FakePokemonLocalDataSource()
        val remote = FakePokemonRemoteDataSource(dto = sampleDto())
        val repository = PokemonExplorerRepositoryImpl(remote, local)
